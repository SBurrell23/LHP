...
- **Names** (top-left of the score) writes the letter name under every note, for anyone still learning the bass clef; **Colors** tints every notehead (and label) by letter using the Chroma-Notes scheme, with a legend above the score.
