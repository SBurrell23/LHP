...
- **Names** (top-left of the score) writes the letter name under every note, for anyone still learning the bass clef; **Colors** tints every notehead (and label) by letter (C blue, D orange, E yellow, F pink, G green, A red, B purple), with a legend above the score.
- **Copy link** shares the exact sheet (`?chords=5&seed=123&key=F&pattern=Walking%20Bass`). **Print / PDF** prints just the sheet. Dark mode inverts the score too.
